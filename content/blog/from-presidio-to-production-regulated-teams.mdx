...
![Presidio production construction illustration](/blog/visuals/presidio-production-layers.svg "Presidio can be the foundation, but regulated teams still need the production layers around detection to operate safely.")
