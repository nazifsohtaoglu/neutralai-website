...
![FCA-safe AI control point](/blog/visuals/fca-ai-control-point.svg "A practical financial-services AI pattern routes prompts through masking, policy, and audit evidence before model delivery.")
