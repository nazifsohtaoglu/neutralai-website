...
![PII masking privacy stage illustration](/blog/visuals/pii-masking-flow.svg "PII masking keeps the business task intact while raw identifiers are removed before the prompt reaches an external model.")
