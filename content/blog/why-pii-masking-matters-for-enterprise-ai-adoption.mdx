...
![PII masking flow diagram](/blog/visuals/pii-masking-flow.svg "PII masking separates useful business context from raw identifiers before prompts reach external model providers.")
