...
![Vendor benchmark evidence map](/blog/visuals/vendor-benchmark-evidence.svg "Public vendor claims are useful, but only comparable when dataset, scorer, entity scope, and metric definitions match.")
