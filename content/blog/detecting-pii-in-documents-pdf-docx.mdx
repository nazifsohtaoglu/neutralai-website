...
The sanitized chunks are kept in a store, but with the same time-limited retention approach as the [vault post](/blog/reversible-pii-masking-ttl-aes-gcm-vault/): a TTL purges the expired ones, and reads go through an owner check.
