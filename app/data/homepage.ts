...
const allPricingFaqs = [
  ...
  },
  {
    ...
    answer: 'Self-serve checkout currently supports monthly billing. Annual billing is not available through these purchase links. Contact sales to discuss contract requirements.',
  },
  {
    question: 'Can I cancel or downgrade my plan?',
    answer:
      'Yes. Plans can be cancelled or downgraded at any time from the billing section of the app. Cancellation takes effect at the end of the current billing period; you retain access to paid features until then.',
  },
  {
