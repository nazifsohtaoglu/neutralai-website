...
| --- | --- | --- | --- | --- | --- |
| Pricing and catalog parity between website and live app/gateway | Product + Gateway Engineering | [#69](https://github.com/nazifsohtaoglu/neutralai-website/issues/69), [gateway#777](https://github.com/nazifsohtaoglu/neutralai-gateway/issues/777) | Pre-launch | Partial: monthly price/checkout parity verified; entitlement parity open | 2026-09-19: four live monthly Checkout totals match website prices. Owner explicitly approved publication with remaining verification limits; see [publication decision and evidence](PRICING_PUBLICATION_2026-09-19.md). Full entitlement parity and production paid activation are not claimed complete. |
...
| Google Sheets production forms, routing, and lead ownership | Revenue Operations + Growth Engineering | [#70](https://github.com/nazifsohtaoglu/neutralai-website/issues/70), `docs/google-sheets-production-verification.md` | Pre-launch | Open | 2026-05-19: verification runbook and non-secret ownership/link matrix updated for Google Sheets; production execution evidence is still pending. |
...
| Cross-CTA conversion funnel QA (signup/demo/contact/playground/extension) | Growth Engineering + QA | [#76](https://github.com/nazifsohtaoglu/neutralai-website/issues/76), `docs/conversion-funnel-qa.md` | Pre-launch | Open | Canonical funnel matrix and repo smoke expectations are now documented; keep open until production Google Sheets/PostHog execution evidence is recorded in linked runbooks. |
| Static hosting/export runbook ownership (redirects, headers, sitemap, output) | Platform/Infra | [#78](https://github.com/nazifsohtaoglu/neutralai-website/issues/78), `docs/deployment-static-runbook.md` | Pre-launch | Open | Runbook now includes explicit closure criteria and private-ops handoff checklist. Keep status `Open` until Platform/Infra posts non-secret completion confirmation in #78 and owner/on-call roles are recorded in private ops docs. |
