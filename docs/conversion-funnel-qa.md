...
- Google Sheets routing validation remains owned by RevOps + Growth Engineering in production using `docs/google-sheets-production-verification.md`.
...
2. Production Google Sheets checks are recorded in `docs/google-sheets-production-verification.md`.
